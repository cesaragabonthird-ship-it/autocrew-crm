    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-orange-950 to-gray-900 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-white/50 text-sm mt-2">Car Accessories Management System</p>
        </div>
        <SignIn
          path="/sign-in"
          routing="path"
        ...
        <div className="text-center mt-4 space-y-1">
          ...
          <p className="text-white/30 text-xs">
            Staff member?{' '}
            <a href="/staff" className="text-white/50 hover:text-white underline">Open Staff Portal</a>
          </p>
        </div>
      </div>
    </div>
